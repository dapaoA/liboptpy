...
methods = {
"PGD": cs.ProjectedGD(f, grad, projection_simplex, ss.Backtracking(rule_type="Armijo", rho=0.5, beta=0.1, init_alpha=1.)),
"dPGD": cs.Dynamic_ProjectedGD(f, grad, projection_simplex, ss.Dynamic_Backtracking(rule_type="Armijo", rho=0.5, beta=0.1, init_alpha=1.)),
           "MD": cs.MirrorD(f, grad, kl_projection,
                                 ss.Backtracking(rule_type="Armijo", rho=0.5, beta=0.1, init_alpha=1.)),
    "dMD": cs.Dynamic_MirrorD(f, grad, kl_projection,
                     ss.Dynamic_Backtracking(rule_type="Armijo", rho=0.5, beta=0.1, init_alpha=1.))
          }
