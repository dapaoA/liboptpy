...
plt.plot(log["opt_proj3"],label=r'$\hat{\theta} \sim \tilde{\theta}^{k}_{3}$', linestyle = "dashdot")
...
plt.plot(log["alg_proj3"],label=r'$\theta^{k} \sim \tilde{\theta}^{k}_{3}$', linestyle = "dashdot")
plt.yscale('log')
plt.title("Distances")
plt.xlabel("rounds")
plt.legend()
...
plt.plot(log["screening_area3"],label=r'$R(\tilde{\theta}^{k}_{3})$', linestyle = "dashdot")
...
plt.plot(log["screening_p3"],label=r'$\tilde{\theta}^{k}_{3}$', linestyle = "dashdot")
plt.title("Sparsity")
plt.xlabel("rounds")
plt.legend()
plt.show()
