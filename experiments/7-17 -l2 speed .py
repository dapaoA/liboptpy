...
from functions import grad_uot_l2 as g
from functions import uot_l2_proximal_l2 as pl2
...
grad = lambda x: g(x, a, b, HcHc,HrHr,Hcb,Hra, dim_a,dim_b)


proximall2 = lambda x,h,grad: pl2(m/tau,x,h,grad)
...
"MD-l2-001": cs.MirrorD_gen(f, grad, proximall2, ss.ConstantStepSize(0.01)),
"MD-l2-0005": cs.MirrorD_gen(f, grad, proximall2, ss.ConstantStepSize(0.005)),
"MD-l2-0001": cs.MirrorD_gen(f, grad, proximall2, ss.ConstantStepSize(0.001)),
