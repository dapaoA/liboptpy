...
time_s = time.time()
G1_tau,log1_tau = ot.unbalanced.mm_unbalanced_dynamic(a, b, M,1,tau, 1000,div='kl',numItermax=round,log=True)
time_e = time.time()
print( "time costs: ", time_e - time_s, " s")
...
time_s = time.time()
G1_q000001v,log_q000001v = ot.unbalanced.mm_unbalanced_dynamic2_stop(a, b, M,0.1,tau,0.00001,2, div='kl',numItermax=round,log=True,stopThr=stopThr)
time_e = time.time()
print( "time costs: ", time_e - time_s, " s")
