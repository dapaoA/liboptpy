...
"MD-KLb": cs.MirrorD_gen(f, grad, proximalB, ss.D_Backtracking(rule_type="Armijo", rho=0.5, beta=0.001, init_alpha=0.25)),
"MD-KLk": cs.MirrorD_gen(f, grad, proximalK, ss.D_Backtracking(rule_type="Armijo", rho=0.5, beta=0.001, init_alpha=0.25)),
...
time_s = time.time()
G1kl = ot.unbalanced.mm_unbalanced(a, b, M, tau, 'kl')
time_e = time.time()
print(m_name, "time costs: ", time_e - time_s, " s")


time_s = time.time()
G1l2 = ot.unbalanced.mm_unbalanced(a, b, M, tau, 'l2')
time_e = time.time()
print(m_name, "time costs: ", time_e - time_s, " s")
