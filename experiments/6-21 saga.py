...
from functions import semi_l2, grad_semi_l2,sto_grad_semi_l2,sto_grads_semi_l2
...
"Saga-md": cs.Sag_MirrorD(f, sto_grads, kl_projection, ss.ConstantStepSize(1),dim_a,batch=1),
