...
print( "time costs: ", time_e - time_s, " s")
time_s = time.time()
G2d_100_r3000,log2d_100_r3000 = ot.unbalanced.mm_unbalanced_dynamic3(a, b, M, 100,tau,3000, l_rate=0.005,div='l2_2',numItermax=round,log=True)
time_e = time.time()
print( "time costs: ", time_e - time_s, " s")
time_s = time.time()
G2d_10_r3000,log2d_10_r3000 = ot.unbalanced.mm_unbalanced_dynamic3(a, b, M, 10,tau,3000, l_rate=0.005,div='l2_2',numItermax=round,log=True)
time_e = time.time()
print( "time costs: ", time_e - time_s, " s")
time_s = time.time()
G2d_50_r3000,log2d_50_r3000 = ot.unbalanced.mm_unbalanced_dynamic3(a, b, M, 50,tau,3000, l_rate=0.005,div='l2_2',numItermax=round,log=True)
time_e = time.time()
print( "time costs: ", time_e - time_s, " s")
time_s = time.time()
G2d_200_r3000,log2d_200_r3000 = ot.unbalanced.mm_unbalanced_dynamic3(a, b, M, 200,tau,3000, l_rate=0.005,div='l2_2',numItermax=round,log=True)
time_e = time.time()
print( "time costs: ", time_e - time_s, " s")
...
convergence = {
    ...
    'l2_2': log2,
    'l2_2a': log2a,
    'l2_2_dynamic-100-r3000': log2d_100_r3000,
    'l2_2_dynamic-50-r3000': log2d_50_r3000,
    'l2_2_dynamic-10-r3000': log2d_10_r3000,
    'l2_2_dynamic-200-r3000': log2d_200_r3000,
...
pot_names = {
    ...
    'l2_2': G2,
    'l2_2a': G2a,
    'l2_2_dynamic-100-r3000': G2d_100_r3000,
    'l2_2_dynamic-50-r3000': G2d_50_r3000,
    'l2_2_dynamic-10-r3000': G2d_10_r3000,
    'l2_2_dynamic-200-r3000': G2d_200_r3000,
             }
