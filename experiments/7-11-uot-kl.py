...
from functions import uot_kl_proximal_B_entropy as p
...
grad = lambda x: g(x, a, b, m, tau, Hc,Hr, dim_a,dim_b)
...
"MD": cs.MirrorD_gen(f, grad, proximal, ss.ConstantStepSize(0.25)),
