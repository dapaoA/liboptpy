...
print( "time costs: ", time_e - time_s, " s")
time_s = time.time()
G_2tau5_100_2,log_2_tau5_100_2 = ot.unbalanced.mm_unbalanced_dynamic3(a, b, M, 1,tau,100,2, l_rate=0.01,div='l2_2',numItermax=round,log=True)
time_e = time.time()
print( "time costs: ", time_e - time_s, " s")
time_s = time.time()
G_2tau5_50_2,log_2_tau5_50_2 = ot.unbalanced.mm_unbalanced_dynamic3(a, b, M, 1,tau,50,2, l_rate=0.01,div='l2_2',numItermax=round,log=True)
time_e = time.time()
print( "time costs: ", time_e - time_s, " s")
time_s = time.time()
G_2tau5_150_2,log_2_tau5_150_2 = ot.unbalanced.mm_unbalanced_dynamic3(a, b, M, 1,tau,150,2, l_rate=0.01,div='l2_2',numItermax=round,log=True)
time_e = time.time()
print( "time costs: ", time_e - time_s, " s")
...
convergence = {
    ...
    'mml2_2-tau-0.01-dy': log_2_tau5_100_2,
    'mml2_2-tau-0.01-dy2': log_2_tau5_50_2,
    'mml2_2-tau-0.01-dy3': log_2_tau5_150_2,
...
pot_names = {
    ...
    'mml2_2-tau-0.01-dy': G_2tau5_100_2,
    'mml2_2-tau-0.01-dy2': G_2tau5_50_2,
    'mml2_2-tau-0.01-dy3': G_2tau5_150_2,
             }
