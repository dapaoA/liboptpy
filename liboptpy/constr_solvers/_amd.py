...
class AMD(Acc_LineSearchOptimizer):
...
#        return np.multiply(x,(np.exp((t_k-1)/t_knew))*(x /self._x_current))
...
class AMD_E(Acc_LineSearchOptimizer): # this amd doing nestrov on mirror space...
    '''
    Class represents projected gradient method
    '''
...
class AMD_gen(Acc_LineSearchOptimizer):
    '''
    Class represents projected gradient method
    '''
